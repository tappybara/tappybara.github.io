...
export default function Home() {
    return (
        <Layout theme="white">
            <div className="flex absolute top-0 z-0 h-screen brightness-[0.65] w-full lg:w-3/6">
                <Image src={Hakodate} alt="hakodate" />
            </div>
            <div className="flex w-full z-10">
                <div className="flex flex-col justify-center items-center min-h-full w-full lg:w-3/6">
                    ...
                    <div className="flex lg:hidden flex-row tracking-wider text-white">

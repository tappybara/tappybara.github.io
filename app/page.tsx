    ...
    return (
        <Layout>
            <div className="flex w-3/6 h-screen">
                <div className="grid relative w-full grid-cols-12 grid-rows-12 gap-5">
                    <Header colour="white" />
                    <div className="flex absolute z-0 h-screen brightness-[0.65]">
                        <Image src={Hakodate} alt="hakodate" />
                    </div>
                    <div className="flex justify-center items-center row-start-6 row-end-8 col-span-12 overflow-hidden z-10">

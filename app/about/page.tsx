            ...
            <div className="flex flex-col w-full">
                <div className="flex min-h-full">
                    <div className="grid w-3/6 grid-cols-12 grid-rows-12 gap-5">
                        <div className="flex relative col-start-2 2xl:col-start-4 col-span-10 2xl:col-span-6 row-start-5 row-span-4 2xl:row-start-3 2xl:row-span-7">
                            <FadeInOnScroll>
                                <Image
                                    src={AboutImage}
                                    alt="Picture of Hina"
                                ...
                                <div className="flex flex-col h-full">
                                    <div className="flex flex-col gap-8 my-auto">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <span>
                                                Hello, I&apos;m Alex Hsieh.
                                            </span>
                                            <div className="flex flex-col gap-0">
                                                <span>---</span>
                                                <span>
                                                    1998 Born in Surrey, BC
                                                </span>
                ...
                <div className="flex min-h-full">
                    <div className="grid w-3/6 grid-cols-12 grid-rows-12 gap-5">
                        <div className="flex relative col-start-2 2xl:col-start-2 col-span-10 2xl:col-span-10 row-start-5 row-span-4 2xl:row-start-5 2xl:row-span-4 overflow-hidden">
                            <FadeInOnScroll>
                                <Image
                                    src={Alex}
                                    alt="alex"
